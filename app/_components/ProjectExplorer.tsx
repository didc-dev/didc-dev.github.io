...
export function ProjectExplorer() {
  ...
  const periods = ["Toutes", "2026", "Avant 2026", "Sans date publiée"];
  ...
  const periodOf = (project: (typeof projects)[number]) => !/\d{4}/.test(project.year) ? "Sans date publiée" : project.year.includes("2026") ? "2026" : "Avant 2026";
